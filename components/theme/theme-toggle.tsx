...
export function MorphingThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <MorphingPopoverContent className="rounded-xl border border-zinc-950/10 bg-gray-500/20 p-0 shadow-[0_9px_9px_0px_rgba(0,0,0,0.01),_0_2px_5px_0px_rgba(0,0,0,0.06)] dark:border-zinc-50/10 dark:bg-white/20">
